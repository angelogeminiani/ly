 ...
 * between the two depending on the scaling hint provided (see {@link org.smartly.commons.image.resize.Resize.Method}).
 * <p/>
 ...
 * better, especially when using the {@link org.smartly.commons.image.resize.Resize.Method#ULTRA_QUALITY} method.
 * <p/>
 * Only when scaling using the {@link org.smartly.commons.image.resize.Resize.Method#AUTOMATIC} method will this class
 * look at the size of the image before selecting an approach to scaling the
 * image. If {@link org.smartly.commons.image.resize.Resize.Method#QUALITY} is specified, the best-looking algorithm
 ...
 * the original image unless a mode of {@link org.smartly.commons.image.resize.Resize.Mode#FIT_EXACT} is specified; in
 ...
 * <p/>
 * When not using {@link org.smartly.commons.image.resize.Resize.Mode#FIT_EXACT}, in order to maintain the
 ...
 * <li>If a {@link org.smartly.commons.image.resize.Resize.Mode} value of {@link org.smartly.commons.image.resize.Resize.Mode#FIT_TO_WIDTH} or
 * {@link org.smartly.commons.image.resize.Resize.Mode#FIT_TO_HEIGHT} is passed in to the <code>resize</code> method,
 ...
 * <h3>Thread Safety</h3>
 * The {@link org.smartly.commons.image.resize.Resize} class is <strong>thread-safe</strong> (as all the methods
...
public class Resize {
    ...
    public static enum Method {
         ...
         * {@link org.smartly.commons.image.resize.Resize#THRESHOLD_QUALITY_BALANCED} or
         * {@link org.smartly.commons.image.resize.Resize#THRESHOLD_BALANCED_SPEED} thresholds as cut-offs to
         ...
         * beyond the work done by {@link org.smartly.commons.image.resize.Resize.Method#QUALITY} to make the image look
         ...
         * jagged with some of the other {@link org.smartly.commons.image.resize.Resize.Method}s (even
         * {@link org.smartly.commons.image.resize.Resize.Method#QUALITY}).
         */
        ULTRA_QUALITY;
    }
    ...
    public static enum Mode {
         ...
         * <p/>
         * See "Image Proportions" in the {@link org.smartly.commons.image.resize.Resize} class description for
         * more detail.
         */
        AUTOMATIC,
        /**
         ...
         * modes or {@link org.smartly.commons.image.resize.Resize.Mode#AUTOMATIC} if you want the image to look
     ...
     * {@link org.smartly.commons.image.resize.Resize.Method#AUTOMATIC} method will decide if a {@link org.smartly.commons.image.resize.Resize.Method#BALANCED}
     * method will be used (if smaller than or equal to threshold) or a
     * {@link org.smartly.commons.image.resize.Resize.Method#SPEED} method will be used (if larger than threshold).
     * <p/>
     ...
     * size need to use a {@link org.smartly.commons.image.resize.Resize.Method#BALANCED} scale method to look decent in
     * most all cases while using the faster {@link org.smartly.commons.image.resize.Resize.Method#SPEED} method for
    ...
    /**
     * Threshold (in pixels) at which point the scaling operation using the
     * {@link org.smartly.commons.image.resize.Resize.Method#AUTOMATIC} method will decide if a {@link org.smartly.commons.image.resize.Resize.Method#QUALITY}
     * method will be used (if smaller than or equal to threshold) or a
     * {@link org.smartly.commons.image.resize.Resize.Method#BALANCED} method will be used (if larger than threshold).
     * <p/>
     * The bigger the image is being scaled to, the less noticeable degradations
     * in the image becomes and the faster algorithms can be selected.
     * <p/>
     ...
     * testing between different types of images scaled with this library; both
     * photographs and screenshots. It was determined that images below this
     * size need to use a {@link org.smartly.commons.image.resize.Resize.Method#QUALITY} scale method to look decent in
     * most all cases while using the faster {@link org.smartly.commons.image.resize.Resize.Method#BALANCED} method for
     * images bigger than this threshold showed no noticeable degradation over a
     ...
     * @throws java.awt.image.ImagingOpException       if one of the given {@link java.awt.image.BufferedImageOp}s fails to apply.
     ...
     *                resulting image. If this value is <code>0</code> then
     *                <code>src</code> is returned unmodified.
     * @param color   The color to fill the padded space with. {@link java.awt.Color}s using
     ...
     * <p/>
     * A scaling method of {@link org.smartly.commons.image.resize.Resize.Method#AUTOMATIC} and mode of
     * {@link org.smartly.commons.image.resize.Resize.Mode#AUTOMATIC} are used.
     * <p/>
     * <strong>TIP</strong>: This operation leaves the original <code>src</code>
     * image unmodified. If the caller is done with the <code>src</code> image
     * after getting the result of this operation, remember to call
     ...
     * <p/>
     * A mode of {@link org.smartly.commons.image.resize.Resize.Mode#AUTOMATIC} is used.
     * <p/>
     * <strong>TIP</strong>: This operation leaves the original <code>src</code>
     * image unmodified. If the caller is done with the <code>src</code> image
     * after getting the result of this operation, remember to call
     ...
     *                                  to fail, even when using straight forward JDK-image
     *                                  operations.
     * @see org.smartly.commons.image.resize.Resize.Method
     */
     ...
     * the given WIDTH or HEIGHT explicitly, depending on the {@link org.smartly.commons.image.resize.Resize.Mode}
     * specified) and apply the given {@link java.awt.image.BufferedImageOp}s (if any) to the
     * result before returning it.
     * <p/>
     * A scaling method of {@link org.smartly.commons.image.resize.Resize.Method#AUTOMATIC} is used.
     * <p/>
     * <strong>TIP</strong>: This operation leaves the original <code>src</code>
     * image unmodified. If the caller is done with the <code>src</code> image
     * after getting the result of this operation, remember to call
     ...
     *                   given width ({@link org.smartly.commons.image.resize.Resize.Mode#FIT_TO_WIDTH}) or fitting the image
     *                   to the given height ({@link org.smartly.commons.image.resize.Resize.Mode#FIT_TO_HEIGHT}). If
     *                   {@link org.smartly.commons.image.resize.Resize.Mode#AUTOMATIC} is passed in, imgscalr will calculate
     ...
     *                   want to use {@link org.smartly.commons.image.resize.Resize.Mode#AUTOMATIC} to "do the right thing".
     * @param targetSize The target width and height (square) that you wish the image
     *                   to fit within.
     * @param ops        <code>0</code> or more optional image operations (e.g.
     *                   sharpen, blur, etc.) that can be applied to the final result
     ...
     *                                  to fail, even when using straight forward JDK-image
     *                                  operations.
     * @see org.smartly.commons.image.resize.Resize.Mode
     */
     ...
     * explicitly, depending on the {@link org.smartly.commons.image.resize.Resize.Mode} specified) and apply the given
     * {@link java.awt.image.BufferedImageOp}s (if any) to the result before returning it.
     * <p/>
     * A scaling method of {@link org.smartly.commons.image.resize.Resize.Method#AUTOMATIC} is used.
     * <p/>
     ...
     * Resize a given image (maintaining its original proportion) to the target
     * width and height (or fitting the image to the given WIDTH or HEIGHT
     * explicitly, depending on the {@link org.smartly.commons.image.resize.Resize.Mode} specified) using the given
    ...
    /**
     * Used to apply a {@link org.smartly.commons.image.resize.Resize.Rotation} and then <code>0</code> or more
     ...
     *                                  to fail, even when using straight forward JDK-image
     *                                  operations.
     * @see org.smartly.commons.image.resize.Resize.Rotation
     */
     ...
     * {@link org.smartly.commons.image.resize.Resize#DEBUG} is <code>true</code>; otherwise the VM will be
     ...
     * @see org.smartly.commons.image.resize.Resize#LOG_PREFIX
     * @see org.smartly.commons.image.resize.Resize#LOG_PREFIX_PROPERTY_NAME
     */
    ...
    /**
     * Used to determine the scaling {@link org.smartly.commons.image.resize.Resize.Method} that is best suited for
     * scaling the image to the targeted dimensions.
     * <p/>
     * This method is intended to be used to select a specific scaling
     * {@link org.smartly.commons.image.resize.Resize.Method} when a {@link org.smartly.commons.image.resize.Resize.Method#AUTOMATIC} method is specified. This
     * method utilizes the {@link org.smartly.commons.image.resize.Resize#THRESHOLD_QUALITY_BALANCED} and
     * {@link org.smartly.commons.image.resize.Resize#THRESHOLD_BALANCED_SPEED} thresholds when selecting which
     ...
     * @return the fastest {@link org.smartly.commons.image.resize.Resize.Method} suited for scaling the image to the
     ...
     * @param targetWidth            The target width for the scaled image.
     * @param targetHeight           The target height for the scaled image.
     * @param interpolationHintValue The {@link java.awt.RenderingHints} interpolation value used to
