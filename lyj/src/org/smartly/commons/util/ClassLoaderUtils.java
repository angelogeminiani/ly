...
public class ClassLoaderUtils {
     ...
     * <li>{@link org.smartly.commons.util.ClassLoaderUtils}.class.getClassLoader().getResource(name)</li>
     * <li>{@link org.smartly.commons.util.ClassLoaderUtils}.class.getResource(name)</li>
     ...
     * @throws InstantiationException    if the class that declares the
     *                                   underlying constructor represents an abstract class
     * @throws java.lang.reflect.InvocationTargetException if the underlying constructor throws
     *                                   an exception
