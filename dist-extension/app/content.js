...
/******/ 	return __webpack_require__(__webpack_require__.s = "./lyts_chrome_extension/content.ts");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./lyts/lyts_core/view/UrlParser.ts":
/*!******************************************!*\
  !*** ./lyts/lyts_core/view/UrlParser.ts ***!
  \******************************************/
/*! exports provided: default */
...
var UrlParser = /** @class */ (function () {
    ...
    Object.defineProperty(UrlParser.prototype, "is_hash", {
        // ------------------------------------------------------------------------
        //                      p u b l i c
        // ------------------------------------------------------------------------
        get: function () {
    ...
    Object.defineProperty(UrlParser.prototype, "is_relative", {
        get: function () {
    ...
    Object.defineProperty(UrlParser.prototype, "hash", {
        get: function () {
    ...
    Object.defineProperty(UrlParser.prototype, "host", {
        get: function () {
    ...
    Object.defineProperty(UrlParser.prototype, "href", {
        get: function () {
    ...
    Object.defineProperty(UrlParser.prototype, "password", {
        get: function () {
    ...
    Object.defineProperty(UrlParser.prototype, "pathname", {
        get: function () {
    ...
    Object.defineProperty(UrlParser.prototype, "protocol", {
        get: function () {
    ...
    Object.defineProperty(UrlParser.prototype, "search", {
        get: function () {
    ...
    Object.defineProperty(UrlParser.prototype, "username", {
        get: function () {
    ...
    UrlParser.prototype.sameOrigin = function (url_param) {
        var url = url_param instanceof UrlParser ? url_param : new UrlParser(url_param);
        return url.protocol == this.protocol && url.origin == this.origin;
    };
    // ------------------------------------------------------------------------
    //                      p r i v a t e
    // ------------------------------------------------------------------------
    UrlParser.prototype.parser = function () {
        if (!this.__parser) {
...
/***/ "./lyts_chrome_extension/application/controller/parse/HTMLParser.ts":
/*!**************************************************************************!*\
  !*** ./lyts_chrome_extension/application/controller/parse/HTMLParser.ts ***!
  \**************************************************************************/
/*! exports provided: default */
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _lyts_lyts_core_commons_BaseObject__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../../lyts/lyts_core/commons/BaseObject */ "./lyts/lyts_core/commons/BaseObject.ts");
/* harmony import */ var _globals__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../globals */ "./lyts_chrome_extension/application/globals.ts");
/* harmony import */ var _lyts_lyts_core_view_UrlParser__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../lyts/lyts_core/view/UrlParser */ "./lyts/lyts_core/view/UrlParser.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var HTMLParser = /** @class */ (function (_super) {
    ...
    function HTMLParser(html) {
        var _this = _super.call(this) || this;
        _this._enabled = !!_globals__WEBPACK_IMPORTED_MODULE_1__["default"].$;
        _this._html = html;
        return _this;
    }
    Object.defineProperty(HTMLParser.prototype, "enabled", {
        // ------------------------------------------------------------------------
        //                      p r o p e r t i e s
        // ------------------------------------------------------------------------
        get: function () {
    ...
    //                      p u b l i c
    // ------------------------------------------------------------------------
    HTMLParser.prototype.links = function (domain, only_textual_links) {
        var _this = this;
        var response = new Array();
        var links = new Array();
        if (this._enabled) {
            var $_1 = _globals__WEBPACK_IMPORTED_MODULE_1__["default"].$;
            var $html = $_1(this._html);
            $html.find("a").each(function (index, elem) {
                var href = !!elem ? elem.getAttribute("href") || "" : "";
                if (!!href && href !== "#") {
                    var matched = _this.match(href, domain);
                    if (!!matched) {
                        if (links.indexOf(matched.href) === -1) {
                            // get text for child nodes
                            var text_1 = new Array();
                            $_1(elem).text(function (index, txt) {
                                if (!!txt) {
                                    text_1.push(txt);
                                }
                                return txt;
    ...
    //                      p r i v a t e
    // ------------------------------------------------------------------------
    HTMLParser.prototype.match = function (url, domain) {
        if (!!url) {
            var original_url = new _lyts_lyts_core_view_UrlParser__WEBPACK_IMPORTED_MODULE_2__["default"](url);
            if (!!domain) {
                var domain_url = new _lyts_lyts_core_view_UrlParser__WEBPACK_IMPORTED_MODULE_2__["default"](domain);
    ...
    //                      F A C T O R Y
    // ------------------------------------------------------------------------
    HTMLParser.create = function (html) {
...
/***/ "./lyts_chrome_extension/application/globals.ts":
/*!******************************************************!*\
  !*** ./lyts_chrome_extension/application/globals.ts ***!
  \******************************************************/
/*! exports provided: default */
...
/***/ "./lyts_chrome_extension/content.ts":
/*!******************************************!*\
  !*** ./lyts_chrome_extension/content.ts ***!
  \******************************************/
/*! no exports provided */
...
/* harmony import */ var _application_model_ModelMessage__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./application/model/ModelMessage */ "./lyts_chrome_extension/application/model/ModelMessage.ts");
/* harmony import */ var _application_controller_chrome_Runtime__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./application/controller/chrome/Runtime */ "./lyts_chrome_extension/application/controller/chrome/Runtime.ts");
/* harmony import */ var _application_globals__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./application/globals */ "./lyts_chrome_extension/application/globals.ts");
/* harmony import */ var _application_controller_parse_HTMLParser__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./application/controller/parse/HTMLParser */ "./lyts_chrome_extension/application/controller/parse/HTMLParser.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var content = /** @class */ (function (_super) {
    ...
    content.prototype.start = function () {
        var _this = this;
        _lyts_lyts_core_ly__WEBPACK_IMPORTED_MODULE_0__["default"].console.debug("content.start", "starting content at:" + new Date());
        if (!!_application_globals__WEBPACK_IMPORTED_MODULE_5__["default"].$) {
            _application_globals__WEBPACK_IMPORTED_MODULE_5__["default"].$(function () {
                // send event to enable show popup
                _application_controller_chrome_Runtime__WEBPACK_IMPORTED_MODULE_4__["default"].sendMessage(_application_model_ModelMessage__WEBPACK_IMPORTED_MODULE_3__["default"].create({ action: _application_model_ModelMessage__WEBPACK_IMPORTED_MODULE_3__["ActionType"].showPageAction }));
                // try to inspect content
                _this.inspectContent();
            });
        }
        else {
            _lyts_lyts_core_ly__WEBPACK_IMPORTED_MODULE_0__["default"].console.error("content.start", "jQuery not loaded.");
        }
    };
    /**
    ...
    content.prototype.onLocalChangeLang = function (lang) {
    };
    content.prototype.inspectContent = function () {
        ...
        _lyts_lyts_core_ly__WEBPACK_IMPORTED_MODULE_0__["default"].lang.funcDelay(function () {
            var html = _application_globals__WEBPACK_IMPORTED_MODULE_5__["default"].$("body")[0].innerHTML;
            var root = document.location.origin;
            var links = _application_controller_parse_HTMLParser__WEBPACK_IMPORTED_MODULE_6__["default"].create(html).links(root, true);
            _lyts_lyts_core_ly__WEBPACK_IMPORTED_MODULE_0__["default"].console.debug("content.inspectContent", root, links);
        }, 1000);
    };
    content.instance = function () {
