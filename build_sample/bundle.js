...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SelectorParser; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__dom__ = __webpack_require__(1);
...
var i18n = /** @class */ (function (_super) {
    ...
    i18n.prototype.localize = function (elem) {
        var _this = this;
        this._localize(elem);
        __WEBPACK_IMPORTED_MODULE_3__dom__["b" /* default */].forEachChild(elem, function (child) {
    ...
    i18n.prototype._localize = function (elem) {
        ...
        if (!!data_i18n) {
            ...
            if (!!value) {
                ...
                if (__WEBPACK_IMPORTED_MODULE_3__dom__["b" /* default */].isInput(elem)) {
                    if (__WEBPACK_IMPORTED_MODULE_3__dom__["b" /* default */].isInputButton(elem)) {
                        __WEBPACK_IMPORTED_MODULE_3__dom__["b" /* default */].setValue(elem, value);
                    }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__application_BaseObject__ = __webpack_require__(15);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var EventEmitter = /** @class */ (function (_super) {
    ...
    function EventEmitter() {
        var _this = _super.call(this) || this;
        _this._events = new __WEBPACK_IMPORTED_MODULE_0__Events__["a" /* default */];
        return _this;
    }
    // ------------------------------------------------------------------------
    //                      p u b l i c
    ...
    return EventEmitter;
}(__WEBPACK_IMPORTED_MODULE_1__application_BaseObject__["a" /* default */]));
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__commons_events_Events__ = __webpack_require__(6);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__commons_events_EventEmitter__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__i18n__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ElementWrapper__ = __webpack_require__(17);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var Component = /** @class */ (function (_super) {
    ...
    Component.prototype.get = function (selector) {
        var result = [];
        var elements = __WEBPACK_IMPORTED_MODULE_1__dom__["b" /* default */].get(selector, this._element);
    ...
    Component.prototype.getFirst = function (selector) {
        return new __WEBPACK_IMPORTED_MODULE_6__ElementWrapper__["a" /* default */](this, __WEBPACK_IMPORTED_MODULE_1__dom__["b" /* default */].getFirst(selector, this._element));
    };
    Component.prototype.getLast = function (selector) {
        return new __WEBPACK_IMPORTED_MODULE_6__ElementWrapper__["a" /* default */](this, __WEBPACK_IMPORTED_MODULE_1__dom__["b" /* default */].getLast(selector, this._element));
    };
    Component.prototype.appendTo = function (selector, clean_parent) {
        ...
        var elem = (selector instanceof __WEBPACK_IMPORTED_MODULE_6__ElementWrapper__["a" /* default */])
            ? selector
            : new __WEBPACK_IMPORTED_MODULE_6__ElementWrapper__["a" /* default */](this, __WEBPACK_IMPORTED_MODULE_1__dom__["b" /* default */].getFirst(selector));
        if (!!elem) {
            if (clean_parent) {
                elem.innerHTML = '';
            }
    ...
    Component.prototype.getValue = function (selector) {
        var elem = this._getFirstElement(selector);
        if (!!elem) {
            return __WEBPACK_IMPORTED_MODULE_1__dom__["b" /* default */].getValue(elem);
        }
        return null;
    };
    // ------------------------------------------------------------------------
    ...
    Component.prototype._normalizeElements = function () {
        ...
        // events on child
        __WEBPACK_IMPORTED_MODULE_1__dom__["b" /* default */].forEachChild(this._element, function (elem) {
    ...
    Component.prototype._getElement = function (selector) {
        return __WEBPACK_IMPORTED_MODULE_1__dom__["b" /* default */].get(selector, this._element);
    };
    Component.prototype._getFirstElement = function (selector) {
        return __WEBPACK_IMPORTED_MODULE_1__dom__["b" /* default */].getFirst(selector, this._element);
    };
    Component.prototype._getLastElement = function (selector) {
        return __WEBPACK_IMPORTED_MODULE_1__dom__["b" /* default */].getLast(selector, this._element);
    };
    ...
    Component.prototype._createElement = function (html) {
        html = html.trim();
        return this._normalizeElement(__WEBPACK_IMPORTED_MODULE_1__dom__["b" /* default */].newElement(html));
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_ly__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_view_dom__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__src_commons_lang__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__view_pages_login_PageLogin__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__i18n_it__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__i18n_en__ = __webpack_require__(22);
...
var emitter = new __WEBPACK_IMPORTED_MODULE_0__src_ly__["a" /* default */].Events();
...
console.log("COUNT", emitter.listenerCount("test"));
console.log("isFunction", __WEBPACK_IMPORTED_MODULE_0__src_ly__["a" /* default */].lang.isFunction(function () {
}));
console.log("isObject", __WEBPACK_IMPORTED_MODULE_0__src_ly__["a" /* default */].lang.isObject(123));
console.log("isObject", __WEBPACK_IMPORTED_MODULE_0__src_ly__["a" /* default */].lang.isObject({}));
console.log("isArray", __WEBPACK_IMPORTED_MODULE_0__src_ly__["a" /* default */].lang.isArray({}));
console.log("isArray", __WEBPACK_IMPORTED_MODULE_0__src_ly__["a" /* default */].lang.isArray([]));
console.log("isBoolean", __WEBPACK_IMPORTED_MODULE_0__src_ly__["a" /* default */].lang.isBoolean({}));
console.log("isBoolean", __WEBPACK_IMPORTED_MODULE_0__src_ly__["a" /* default */].lang.isBoolean([]));
// cookies
console.log("test-cookie", __WEBPACK_IMPORTED_MODULE_0__src_ly__["a" /* default */].cookies.read("test-cookie"));
__WEBPACK_IMPORTED_MODULE_0__src_ly__["a" /* default */].cookies.create("test-cookie", "test " + new Date(), 0);
console.log("test-cookie", __WEBPACK_IMPORTED_MODULE_0__src_ly__["a" /* default */].cookies.read("test-cookie"));
// browser
__WEBPACK_IMPORTED_MODULE_0__src_ly__["a" /* default */].browser.onResize(function (width, height) {
    console.log(width, height);
});
// http client
var client = new __WEBPACK_IMPORTED_MODULE_0__src_ly__["a" /* default */].HttpClient();
// simple get
...
// random
console.log("random 1-2", __WEBPACK_IMPORTED_MODULE_0__src_ly__["a" /* default */].random.rnd(1, 2));
console.log("uniqueId", __WEBPACK_IMPORTED_MODULE_0__src_ly__["a" /* default */].random.uniqueId("id"));
console.log("uniqueId", __WEBPACK_IMPORTED_MODULE_0__src_ly__["a" /* default */].random.uniqueId("id"));
console.log("uniqueId", __WEBPACK_IMPORTED_MODULE_0__src_ly__["a" /* default */].random.uniqueId("id"));
console.log("uniqueId", __WEBPACK_IMPORTED_MODULE_0__src_ly__["a" /* default */].random.uniqueId("id-"));
// to
console.log("toInt", __WEBPACK_IMPORTED_MODULE_0__src_ly__["a" /* default */].lang.toInt("wee"));
console.log("toInt", __WEBPACK_IMPORTED_MODULE_0__src_ly__["a" /* default */].lang.toInt("1"));
console.log("toInt", __WEBPACK_IMPORTED_MODULE_0__src_ly__["a" /* default */].lang.toInt("1.2"));
console.log("toInt", __WEBPACK_IMPORTED_MODULE_0__src_ly__["a" /* default */].lang.toInt("6", -1, 3, 7));
console.log("toInt", __WEBPACK_IMPORTED_MODULE_0__src_ly__["a" /* default */].lang.toInt("10", -1, 3, 7));
console.log("toInt", __WEBPACK_IMPORTED_MODULE_0__src_ly__["a" /* default */].lang.toInt("1", -1, 3, 7));
console.log("toFloat", __WEBPACK_IMPORTED_MODULE_0__src_ly__["a" /* default */].lang.toFloat("wee"));
console.log("toFloat", __WEBPACK_IMPORTED_MODULE_0__src_ly__["a" /* default */].lang.toFloat("1"));
console.log("toFloat", __WEBPACK_IMPORTED_MODULE_0__src_ly__["a" /* default */].lang.toFloat("1.2"));
console.log("toFloat", __WEBPACK_IMPORTED_MODULE_0__src_ly__["a" /* default */].lang.toFloat("6,9", -1, 3, 7));
console.log("toFloat", __WEBPACK_IMPORTED_MODULE_0__src_ly__["a" /* default */].lang.toFloat("10", -1, 3, 7));
console.log("toFloat", __WEBPACK_IMPORTED_MODULE_0__src_ly__["a" /* default */].lang.toFloat("1,0", -1, 3, 7));
// objects
console.log("name.value", __WEBPACK_IMPORTED_MODULE_0__src_ly__["a" /* default */].objects.get({ "name": { "value": 1 } }, "name.value"));
console.log("[name,value]", __WEBPACK_IMPORTED_MODULE_0__src_ly__["a" /* default */].objects.get({ "name": { "value": 1 } }, ["name", "value"]));
console.log("length", __WEBPACK_IMPORTED_MODULE_0__src_ly__["a" /* default */].objects.get([1, 2], ["length"]));
// format
console.log("template", __WEBPACK_IMPORTED_MODULE_0__src_ly__["a" /* default */].format.template("CIAO \n{{name}} {{surname}}", { "name": "Mario", "surname": "Rossi" }));
console.log("date", __WEBPACK_IMPORTED_MODULE_0__src_ly__["a" /* default */].format.date(new Date(__WEBPACK_IMPORTED_MODULE_0__src_ly__["a" /* default */].random.now())));
console.log("date", __WEBPACK_IMPORTED_MODULE_0__src_ly__["a" /* default */].format.date(new Date(__WEBPACK_IMPORTED_MODULE_0__src_ly__["a" /* default */].random.now()), "yyyymmdd"));
console.log("date", __WEBPACK_IMPORTED_MODULE_0__src_ly__["a" /* default */].format.date(new Date(__WEBPACK_IMPORTED_MODULE_0__src_ly__["a" /* default */].random.now()), "dd MM yyyy"));
// dom
var elem = __WEBPACK_IMPORTED_MODULE_0__src_ly__["a" /* default */].dom.get("#app_content");
console.log(typeof elem, elem[0]);
console.log(elem[0].innerHTML);
var elems = __WEBPACK_IMPORTED_MODULE_0__src_ly__["a" /* default */].dom.get(".app");
console.log(typeof elems, elems);
function Start() {
    var _this = this;
    var html = '<div id="test_comp" data-langs="en it" data-lang="english">' +
        '<span>' +
        ...
        '</div>';
    var html2 = "<div>\n            <span></span> \n        <div>";
    var elem = __WEBPACK_IMPORTED_MODULE_1__src_view_dom__["b" /* default */].newElement(html, "#app_content");
    var handler_click = function (e) {
        e.preventDefault();
        // evaluate script
        __WEBPACK_IMPORTED_MODULE_0__src_ly__["a" /* default */].lang.evalScript("alert('THIS IS A MESSAGE FROM SCRIPT: ' +  this )");
        elem.removeEventListener("click", handler_click);
    };
    elem.addEventListener("click", handler_click);
    console.log("START dom.forEachChild");
    __WEBPACK_IMPORTED_MODULE_1__src_view_dom__["b" /* default */].forEachChild(elem, function (child) {
        console.log("elem child", child);
    }, true);
    console.log("END dom.forEachChild");
    var span = __WEBPACK_IMPORTED_MODULE_1__src_view_dom__["b" /* default */].map(elem, function (child) {
        // console.log("tagName", child.tagName);
        return child.tagName.toLowerCase() === 'span';
    }, true);
    console.log("map 'span'", span);
    var selected_span = __WEBPACK_IMPORTED_MODULE_1__src_view_dom__["b" /* default */].get("span", elem);
    console.log("selected 'span'", selected_span);
    // func invoke
    var inv_res = __WEBPACK_IMPORTED_MODULE_2__src_commons_lang__["a" /* default */].funcInvoke(function () {
        var args = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            args[_i] = arguments[_i];
        }
        console.log("=>INSIDE invoke", _this, args);
        return "INVOKED!";
    }, "arg1", "arg2");
    console.log("funcInvoke", inv_res);
    // func once
    var func_once = __WEBPACK_IMPORTED_MODULE_2__src_commons_lang__["a" /* default */].funcOnce(function (now) {
        console.log("ONCE", now);
        return now;
    }, __WEBPACK_IMPORTED_MODULE_0__src_ly__["a" /* default */].random.now());
    console.log("invoking func_one", func_once());
    console.log("invoking func_one", func_once());
    // func delay
    var func_delay_id = __WEBPACK_IMPORTED_MODULE_0__src_ly__["a" /* default */].lang.funcDelay(function (arg1) {
        console.log("DELAYED", arg1);
        __WEBPACK_IMPORTED_MODULE_0__src_ly__["a" /* default */].i18n.registerDefault(__WEBPACK_IMPORTED_MODULE_4__i18n_it__["a" /* default */]);
        __WEBPACK_IMPORTED_MODULE_0__src_ly__["a" /* default */].i18n.register("it", __WEBPACK_IMPORTED_MODULE_4__i18n_it__["a" /* default */]);
        __WEBPACK_IMPORTED_MODULE_0__src_ly__["a" /* default */].i18n.register("en", __WEBPACK_IMPORTED_MODULE_5__i18n_en__["a" /* default */]);
        // test the component
        var page = new __WEBPACK_IMPORTED_MODULE_3__view_pages_login_PageLogin__["a" /* default */]();
        ...
        var input1 = __WEBPACK_IMPORTED_MODULE_1__src_view_dom__["b" /* default */].getFirst("[data-id=username]");
        console.log("\"[data-id=\\\"username\\\"]\" is INPUT-TEXT", input1, __WEBPACK_IMPORTED_MODULE_1__src_view_dom__["b" /* default */].isInputText(input1));
        return arg1;
    }, 2000, "arg1");
    console.log("clearTimeout: ", func_delay_id);
    // clearTimeout(func_delay_id);
    // func debounce
    var func_debounced = __WEBPACK_IMPORTED_MODULE_0__src_ly__["a" /* default */].lang.funcDebounce(this, function (arg1) {
    ...
    console.log("DEBOUNCE RESPONSE", func_debounced());
    // Selector parser
    var selector_parser = new __WEBPACK_IMPORTED_MODULE_1__src_view_dom__["a" /* SelectorParser */]("[data-langs~='en']");
    ...
    var selector_parser2 = new __WEBPACK_IMPORTED_MODULE_1__src_view_dom__["a" /* SelectorParser */]("[data-langs='en']");
    ...
    var selector_parser3 = new __WEBPACK_IMPORTED_MODULE_1__src_view_dom__["a" /* SelectorParser */]("[data-langs|='en']");
    ...
    var selector_parser4 = new __WEBPACK_IMPORTED_MODULE_1__src_view_dom__["a" /* SelectorParser */]("[data-lang|='en']");
    ...
    var selector_parser5 = new __WEBPACK_IMPORTED_MODULE_1__src_view_dom__["a" /* SelectorParser */]("[data-lang='en']");
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__commons_lang__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__commons_format__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__commons_strings__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__commons_objects__ = __webpack_require__(9);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__view_cookies__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__view_dom__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__view_i18n__ = __webpack_require__(5);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__commons_events_EventEmitter__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__net_HttpClient__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__view_components_Component__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__application_Application__ = __webpack_require__(18);
//-- static --//
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__objects__ = __webpack_require__(9);
...
var BaseObject = /** @class */ (function () {
    ...
    // ------------------------------------------------------------------------
    function BaseObject() {
        this._uid = __WEBPACK_IMPORTED_MODULE_0__commons_random__["a" /* default */].uniqueId("lyts_object_");
    }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__PageLoginView__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_view_i18n__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__src_view_components_Component__ = __webpack_require__(10);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var PageLogin = /** @class */ (function (_super) {
    ...
    PageLogin.prototype.render = function () {
        return Object(__WEBPACK_IMPORTED_MODULE_0__PageLoginView__["a" /* default */])(this.uid, { test: "hello" });
    };
    ...
    PageLogin.prototype.init = function () {
        var _this = this;
        var btn_click = _super.prototype.getFirst.call(this, "[data-id=btn-click]");
        // handle events
        // super.addEventListener("[data-id=btn-click]", "click", this.handleClick);
        btn_click.addEventListener("click", this.handleClick);
        _super.prototype.addEventListener.call(this, "[data-id=btn-click-remove]", "click", this.handleClickRemove);
        _super.prototype.addEventListener.call(this, "[data-id=username]", "keydown", function () {
            console.log("change input", _super.prototype.getValue.call(_this, "[data-id=username]"));
        });
        _super.prototype.addEventListener.call(this, "[data-id=check]", "change", function () {
            console.log("change check", _super.prototype.getValue.call(_this, "[data-id=check]"));
        });
        ...
        __WEBPACK_IMPORTED_MODULE_1__src_view_i18n__["a" /* default */].on(__WEBPACK_IMPORTED_MODULE_1__src_view_i18n__["a" /* default */].EVENT_CHANGE_LANG, function () {
    ...
    PageLogin.prototype.handleClick = function () {
        ...
        __WEBPACK_IMPORTED_MODULE_1__src_view_i18n__["a" /* default */].lang = __WEBPACK_IMPORTED_MODULE_1__src_view_i18n__["a" /* default */].lang === "it" ? "en" : "it";
    };
    ...
    return PageLogin;
}(__WEBPACK_IMPORTED_MODULE_2__src_view_components_Component__["a" /* default */]));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_view_i18n__ = __webpack_require__(5);
