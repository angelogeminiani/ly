...
public abstract class ImageParser extends BinaryFileParser implements
     ...
     * implementation.
     * @throws java.io.IOException In the event of unsuccessful data read operation.
     */
     ...
     * content does not conform to the format of the specific parser
     * implementation.
     * @throws java.io.IOException In the event of unsuccessful file read or
     * access operation.
     */
     ...
     * content does not conform to the format of the specific parser
     * implementation.
     * @throws java.io.IOException In the event of unsuccessful data
     * access operation.
     */
     ...
     * content does not conform to the format of the specific parser
     * implementation.
     * @throws java.io.IOException In the event of unsuccessful read or
     * access operation.
     */
     ...
     * @throws java.io.IOException In the event of an write error from
     * the output stream.
     */
