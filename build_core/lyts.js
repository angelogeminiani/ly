...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__commons_console__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__commons_lang__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__commons_format__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__commons_arrays__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__commons_strings__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__commons_objects__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__commons_MD5__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__commons_random__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__view_browser__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__view_installer__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__view_cookies__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__view_dom__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__view_i18n__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__commons_collections_Dictionary__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__commons_events_Events__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__commons_events_EventEmitter__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__net_HttpClient__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__view_components_Component__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__application_Application__ = __webpack_require__(21);
//-- static --//
...
var ly = {
    window: root,
    console: __WEBPACK_IMPORTED_MODULE_0__commons_console__["a" /* default */],
    lang: __WEBPACK_IMPORTED_MODULE_1__commons_lang__["a" /* default */],
    format: __WEBPACK_IMPORTED_MODULE_2__commons_format__["a" /* default */],
    arrays: __WEBPACK_IMPORTED_MODULE_3__commons_arrays__["a" /* default */],
    strings: __WEBPACK_IMPORTED_MODULE_4__commons_strings__["a" /* default */],
    objects: __WEBPACK_IMPORTED_MODULE_5__commons_objects__["a" /* default */],
    MD5: __WEBPACK_IMPORTED_MODULE_6__commons_MD5__["a" /* default */],
    random: __WEBPACK_IMPORTED_MODULE_7__commons_random__["a" /* default */],
    browser: __WEBPACK_IMPORTED_MODULE_8__view_browser__["a" /* default */],
    installer: __WEBPACK_IMPORTED_MODULE_9__view_installer__["a" /* default */],
    cookies: __WEBPACK_IMPORTED_MODULE_10__view_cookies__["a" /* default */],
    dom: __WEBPACK_IMPORTED_MODULE_11__view_dom__["a" /* default */],
    i18n: __WEBPACK_IMPORTED_MODULE_12__view_i18n__["a" /* default */],
    Events: __WEBPACK_IMPORTED_MODULE_14__commons_events_Events__["a" /* default */],
    EventEmitter: __WEBPACK_IMPORTED_MODULE_15__commons_events_EventEmitter__["a" /* default */],
    Dictionary: __WEBPACK_IMPORTED_MODULE_13__commons_collections_Dictionary__["a" /* Dictionary */],
    HttpClient: __WEBPACK_IMPORTED_MODULE_16__net_HttpClient__["a" /* HttpClient */],
    //-- v i e w --//
    Component: __WEBPACK_IMPORTED_MODULE_17__view_components_Component__["a" /* default */],
    //-- s i n g l e t o n --//
    Application: __WEBPACK_IMPORTED_MODULE_18__application_Application__["a" /* default */]
};
// ------------------------------------------------------------------------
//                      e x p o r t s
// ------------------------------------------------------------------------
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ly__ = __webpack_require__(3);
...
var domClass = /** @class */ (function () {
    ...
    domClass.prototype.ready = function (callback, bind_context) {
        if (__WEBPACK_IMPORTED_MODULE_3__ly__["default"].lang.isFunction(callback)) {
            var callback_to_invoke = callback.bind(bind_context || this);
            if (dom._ready) {
                __WEBPACK_IMPORTED_MODULE_3__ly__["default"].lang.funcDelay(callback_to_invoke, 1);
            }
            else {
    ...
    domClass.prototype.createElement = function (tag, target) {
        ...
        else if (__WEBPACK_IMPORTED_MODULE_3__ly__["default"].lang.isString(target)) {
    ...
    domClass.prototype.onDocumentReady = function () {
        ...
        this._readyList.forEach(function (callback) {
            __WEBPACK_IMPORTED_MODULE_3__ly__["default"].lang.funcDelay(callback, 1000);
        });
        this._readyList = [];
    };
...
var objects = /** @class */ (function () {
    ...
    objects.set = function (scope, path, value) {
        ...
        var paths = __WEBPACK_IMPORTED_MODULE_0__lang__["a" /* default */].isArray(path) ? path : path.split('.');
        var count = 0;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__objects__ = __webpack_require__(11);
...
var arrays = /** @class */ (function () {
    ...
    arrays.pushFlatten = function (array) {
        ...
        items.forEach(function (item) {
            if (__WEBPACK_IMPORTED_MODULE_0__ly__["default"].lang.isArray(item)) {
...
var ElementWrapper = /** @class */ (function () {
    ...
    ElementWrapper.prototype.onClick = function (handler, context) {
        this.addEventListener("click", __WEBPACK_IMPORTED_MODULE_2__ly__["default"].lang.funcDebounce(!!context ? context : this, handler, 500, true));
    };
    /**
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__view_i18n__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__commons_events_EventEmitter__ = __webpack_require__(6);
