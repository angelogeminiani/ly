...
public abstract class ConversionUtils {
    ...
    /**
     * Returns a {@link java.text.NumberFormat} instance for the specified
     * format and {@link java.util.Locale}.  If the format specified is a standard
     ...
     * {@link java.text.NumberFormat} will be returned.
     *
     * @param format the custom or standard formatting pattern to be used
     * @param locale the {@link java.util.Locale} to be used
     * @return an instance of {@link java.text.NumberFormat}
     ...
     * this will convert to {@link Number} from a {@link Number}, {@link java.util.Calendar},
     * or {@link java.util.Date}.  If it can't do that, it will get the string value and have
     * {@link #toNumber(String, String, java.util.Locale)} try to parse it using the
     ...
     * specified format and {@link java.util.Locale} to parse it.
     *
     ...
     * specified format and {@link java.util.Locale} to parse it, if necessary.
     *
    ...
    /**
     * Returns a {@link java.text.DateFormat} instance for the specified
     * format, {@link java.util.Locale}, and {@link java.util.TimeZone}.  If the format
     ...
     * specified style.  If it is a custom format, then a customized
     * {@link java.text.SimpleDateFormat} will be returned.
     *
     * @param format   the custom or standard formatting pattern to be used
     * @param locale   the {@link java.util.Locale} to be used
     * @param timezone the {@link java.util.TimeZone} to be used
     * @return an instance of {@link java.text.DateFormat}
    ...
    /**
     * Returns a {@link java.text.DateFormat} instance for the specified
     * date style, time style, {@link java.util.Locale}, and {@link java.util.TimeZone}.
     *
     ...
     * @param timezone  the {@link java.util.TimeZone} to be used
     * @return an instance of {@link java.text.DateFormat}
     * @see #getDateFormat(int timeStyle, int dateStyle, java.util.Locale locale, java.util.TimeZone timezone)
     */
    ...
    /**
     * Returns a {@link java.text.DateFormat} instance for the specified
     * time style, date style, {@link java.util.Locale}, and {@link java.util.TimeZone}.
     *
     ...
     * @param locale    the {@link java.util.Locale} to be used
     * @param timezone  the {@link java.util.TimeZone} to be used
     * @return an instance of {@link java.text.DateFormat} or <code>null</code>
     *         if an instance cannot be constructed with the given
     *         parameters
     */
    ...
    /**
     * Attempts to convert an unidentified {@link Object} into a {@link java.util.Date},
     * just short of turning it into a string and parsing it.  In other words,
     * this will convert to {@link java.util.Date} from a {@link java.util.Date}, {@link java.util.Calendar},
    ...
    /**
     * Converts an object to an instance of {@link java.util.Date} using the
     * specified format, {@link java.util.Locale}, and {@link java.util.TimeZone} if the
     ...
     * @return the object as a {@link java.util.Date} or <code>null</code> if no
     *         conversion is possible
     * @see #getDateFormat
     ...
     * @param locale   - the {@link java.util.Locale}
     * @param timezone - the {@link java.util.TimeZone}
     * @return the string as a {@link java.util.Date} or <code>null</code> if the
     *         parsing fails
     * @see #getDateFormat
     * @see java.text.SimpleDateFormat#parse
     */
    ...
    /**
     * Converts a string to a {@link java.net.URL}.  It will first try to
     ...
     * @return the {@link java.net.URL} form of the string or {@code null}
     * @see java.io.File
